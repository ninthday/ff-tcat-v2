...
if (!is_resource($thislockfp)) {
    logit("ff-search", "search.php is already running (maybe through cron?). exiting now.");
    exit();
}
...
$keywords = $searchbin['keywords']; // separate keywords by 'OR', limit your search to 10 keywords and operators, max 500 characters - https://dev.twitter.com/docs/using-search
